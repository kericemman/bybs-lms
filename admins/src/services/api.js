...
export const adminApi = {
  ...
  getCohortRanking: (id) => api.get(`/cohorts/${id}/ranking`),
  ...
  resendUserWelcomeEmail: (id) => api.post(`/users/${id}/welcome-email`, {}),
  ...
  revokeCertificate: (id, payload) => api.post(`/admin/certificates/${id}/revoke`, payload),
