...
function accessRows(access) {
  ...
  const passwordRow = access.password
    ? `<tr>
        ...
        <td style="padding:12px;color:#10233F;font-weight:700;">${escapeHtml(access.password)}</td>
      </tr>`
    : `<tr>
        <td style="padding:12px;color:#6B7280;font-size:12px;text-transform:uppercase;">Password</td>
        <td style="padding:12px;color:#10233F;font-weight:700;">Use your existing BYBS LMS password.</td>
      </tr>`;

  return `<h2 style="margin:24px 0 8px;color:#10233F;font-size:16px;">Your beta access</h2>
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #E5E7EB;border-radius:8px;margin:10px 0 18px;">
      <tr>
        <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#6B7280;font-size:12px;text-transform:uppercase;">Login link</td>
        <td style="padding:12px;border-bottom:1px solid #E5E7EB;"><a href="${escapeHtml(access.loginUrl)}" style="color:#00337C;font-weight:700;">${escapeHtml(access.loginUrl)}</a></td>
      </tr>
      <tr>
        <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#6B7280;font-size:12px;text-transform:uppercase;">Email</td>
        <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#10233F;font-weight:700;">${escapeHtml(access.user.email)}</td>
      </tr>
      ${passwordRow}
    </table>
    <a href="${escapeHtml(access.loginUrl)}" style="display:inline-block;background:#00337C;color:#FFFFFF;text-decoration:none;border-radius:6px;padding:12px 16px;font-size:14px;font-weight:700;">Open your ${escapeHtml(portalLabel(access.user.role))}</a>`;
}
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:680px;background:#FFFFFF;border:1px solid #E5E7EB;border-radius:8px;overflow:hidden;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td valign="middle" style="color:#FFFFFF;vertical-align:middle;padding-left:14px;">
                      ...
                      <div style="margin-top:4px;font-size:20px;font-weight:700;">BYBS LMS Beta Testing</div>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:28px;">
                <h1 style="margin:0 0 10px;color:#10233F;font-size:24px;line-height:1.3;">Hi ${escapeHtml(firstName(application))}, you have been accepted</h1>
                <p style="margin:0 0 18px;color:#374151;font-size:14px;line-height:1.7;">Thank you for applying to help test the BYBS LMS. We are happy to confirm that you have been accepted as a <strong>${escapeHtml(testerType)}</strong>.</p>
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #E5E7EB;border-radius:8px;margin:18px 0;">
                  <tr>
                    <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#6B7280;font-size:12px;text-transform:uppercase;">Testing window</td>
                    <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#10233F;font-weight:700;">July 3 to July 17, 2026</td>
                  </tr>
                  <tr>
                    <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#6B7280;font-size:12px;text-transform:uppercase;">Portal</td>
                    <td style="padding:12px;border-bottom:1px solid #E5E7EB;color:#10233F;font-weight:700;">${escapeHtml(portalLabel(application.applicantType))}</td>
                  </tr>
                  <tr>
                    <td style="padding:12px;color:#6B7280;font-size:12px;text-transform:uppercase;">Email</td>
                    <td style="padding:12px;color:#10233F;font-weight:700;">${escapeHtml(application.email)}</td>
                  </tr>
                </table>
                ${accessRows(access)}
                <h2 style="margin:24px 0 8px;color:#10233F;font-size:16px;">What happens next</h2>
                ...
                <p style="margin:0 0 18px;color:#374151;font-size:14px;line-height:1.7;">You can also visit the main BYBS website to stay connected to the wider mission: <a href="${escapeHtml(websiteUrl)}" style="color:#00337C;font-weight:700;">${escapeHtml(websiteUrl)}</a>.</p>
                <p style="margin:22px 0 0;color:#6B7280;font-size:12px;line-height:1.6;">If you did not apply for BYBS LMS beta testing, you can ignore this email.</p>
              </td>
            </tr>
            <tr>
