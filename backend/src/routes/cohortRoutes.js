...
import { cohortRanking, createCohort, deleteCohort, listCohorts, updateCohort } from "../controllers/cohortController.js";
...
cohortRoutes.get("/:id/ranking", validate(idParamsSchema), cohortRanking);
